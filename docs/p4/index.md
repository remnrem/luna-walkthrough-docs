# Step 4: epoch-level artifact detection/interpolation

In this last step of QC, we'll perform three major steps:

 - create a [revised project](harm2.md) (`harm1` -> `harm2`) in which we deal with the remaining [injected manipulations](../data.md) of signals and annotations
